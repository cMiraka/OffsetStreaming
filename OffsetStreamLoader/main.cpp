...
namespace Globals {
	...
	namespace StreamedVariables {
		uintptr_t GWorld; // https://github.com/kenn-notation/OffsetStreaming/ExampleOffset -> 0xDEADBEEF for example
	}
}
...
void GetVarFromServer() {
	while (true)
	{
		std::string Offset = Utils::GetString("https://github.com/kenn-notation/OffsetStreaming/ExampleOffset");
